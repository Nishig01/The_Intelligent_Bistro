...
export const menuData: MenuItem[] = [
  {
    ...
    "description": "A delightful serving of fresh pinot noir, prepared with our chef's special recipe to bring out the finest flavors.",
    "price": 18,
    "category": "Drinks",
  ...
  },
  {
    ...
    "description": "A delightful serving of signature tiramisu, prepared with our chef's special recipe to bring out the finest flavors.",
    "price": 16,
    "category": "Desserts",
  ...
  },
  {
    ...
    "price": 18,
    "category": "Desserts",
    "imageUrl": "https://images.unsplash.com/photo-1658428453472-a42cc07548b2?auto=format&fit=crop&q=80&w=800",
    "options": [
      "Add Bacon",
      "Extra Cheese",
      "No Onions"
